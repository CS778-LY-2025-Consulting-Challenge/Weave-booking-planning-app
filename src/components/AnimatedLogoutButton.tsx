...
export default function AnimatedLogoutButton({
  ...
  const handleClick = () => {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        buttonRef.current?.classList.add('falling');
        ...
        setTimeout(() => {
          ...
          setTimeout(() => {
            ...
            setTimeout(() => {
              ...
              buttonRef.current?.classList.remove('door-slammed');
              buttonRef.current?.classList.remove('falling');
  ...
  return (
    <>
      <style jsx global>{`
        ...
        .animated-logout-button:hover .logout-door {
        ...
        .animated-logout-button:active .logout-door {
        ...
        .animated-logout-button.clicked .logout-door {
          transform: rotateY(35deg);
        }

        .animated-logout-button.door-slammed .logout-door {
          transform: none;
          transition: transform 100ms ease-in 250ms;
        }

        .animated-logout-button.falling {
          animation: logout-shake 200ms linear;
        }

        .animated-logout-button.falling .logout-bang {
          animation: logout-flash 300ms linear;
        }

        .animated-logout-button.falling .logout-figure {
      ...
      <button
        ...
        className={`animated-logout-button ${className}`}
        disabled={isAnimating}
      >
        <span className="relative z-10 mr-12">
          Log Out
        </span>
        <svg className="logout-doorway" viewBox="0 0 100 100">
          <path d="M93.4 86.3H58.6c-1.9 0-3.4-1.5-3.4-3.4V17.1c0-1.9 1.5-3.4 3.4-3.4h34.8c1.9 0 3.4 1.5 3.4 3.4v65.8c0 1.9-1.5 3.4-3.4 3.4z" />
          <path
            className="logout-bang"
