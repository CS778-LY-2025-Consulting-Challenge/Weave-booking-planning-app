  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white p-4">
      ...
      <div className="w-full max-w-6xl mx-auto">
        <div className="grid lg:grid-cols-2 bg-background rounded-3xl overflow-hidden shadow-2xl">
          {/* Left Content Section */}
          <div className="relative hidden lg:flex flex-col justify-center items-center bg-gradient-to-br from-primary/90 via-primary to-primary/80 p-12 text-primary-foreground">
